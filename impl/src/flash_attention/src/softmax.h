...
template <bool Scale_max = true, typename Engine0, typename Layout0, typename Engine1,
          typename Layout1>
...
struct Softmax {
    ...
    __forceinline__ __device__ void softmax_rescale_o(Tensor0& acc_s, Tensor1& acc_o,
