...
template<> __device__ inline float elementwise_op<Elementwise_Add, float>(float a, float b) {
    return a + b;
}
template<> __device__ inline float elementwise_op<Elementwise_Sub, float>(float a, float b) {
    return a - b;
}
template<> __device__ inline float elementwise_op<Elementwise_Mul, float>(float a, float b) {
    return a * b;
}
template<> __device__ inline float elementwise_op<Elementwise_Div, float>(float a, float b) {
    return a / b;
}
template<> __device__ inline float elementwise_op<Elementwise_Max, float>(float a, float b) {
    return (a > b) ? a : b;
}
template<> __device__ inline float elementwise_op<Elementwise_Min, float>(float a, float b) {
    return (a > b) ? b : a;
}
template<> __device__ inline float elementwise_op<Elementwise_Pow, float>(float a, float b) {
    return powf(a ,b);
}


template<> __device__ inline int32_t elementwise_op<Elementwise_Add, int32_t>(int32_t a, int32_t b) {
    return a + b;
}
template<> __device__ inline int32_t elementwise_op<Elementwise_Sub, int32_t>(int32_t a, int32_t b) {
    return a - b;
}
template<> __device__ inline int32_t elementwise_op<Elementwise_Mul, int32_t>(int32_t a, int32_t b) {
    return a * b;
}
template<> __device__ inline int32_t elementwise_op<Elementwise_Div, int32_t>(int32_t a, int32_t b) {
    return a / b;
}
template<> __device__ inline int32_t elementwise_op<Elementwise_Max, int32_t>(int32_t a, int32_t b) {
    return (a > b) ? a : b;
}
template<> __device__ inline int32_t elementwise_op<Elementwise_Min, int32_t>(int32_t a, int32_t b) {
    return (a > b) ? b : a;
}
template<> __device__ inline int32_t elementwise_op<Elementwise_Pow, int32_t>(int32_t a, int32_t b) {
    return powf(a ,b);
}
