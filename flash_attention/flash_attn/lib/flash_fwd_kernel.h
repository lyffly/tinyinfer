...
#pragma unroll
    ...
    Tensor gQ =
        make_tensor(make_gmem_ptr(reinterpret_cast<Element*>(params.q_ptr) + row_offset_q),
...
inline __device__ void compute_attn(const Params& params) {
    ...
    flash::compute_attn_1rowblock<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi,
                                  Is_even_MN, Is_even_K, Return_softmax>(params, bidb, bidh,
                                                                         m_block);
}
...
#pragma unroll
    for (int l = 0; l < kNLsePerThread; ++l) {
        ...
        ElementAccum lse = (row < params.num_splits &&
